  ...
  return (
    <>
      ...
      <div className='w-full flex justify-center'>
        ...
        {cities.length > 0 && <h1 className="grid w-5/6 justify-items-center text-white text-2xl text-center font-bold">Aprobar ciudades
        ...
        {users.length > 0 && <h1 className=" mt-5 w-2/5 text-white text-2xl text-center font-bold"> Administrar usuarios </h1>}
